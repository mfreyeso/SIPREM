...
$(document).ready(function(){
	...
	jQuery.validator.addMethod("multianualcheck", function(value, element)
	{
		var anoInicial = document.getElementById("anoi").value;
		if (anoInicial > value){
			var errors = {};
			errors[element.name] = "El Año inicial no puede ser posterior al Año Inicial";
			this.showErrors(errors);
		}
		else{
			this.hideErrors();
	...
	$('#resumeneventos').validate({
		...
		messages:{
			...
			anof : "El año inicial no puede ser posterior al año final",
