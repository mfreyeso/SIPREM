class acumulado(object):
	...
	def __init__(self, coleccionEventosP):
		super(acumulado, self).__init__()
		self.coleccionEventos = coleccionEventosP
		self.etiquetasTrimestres = ["Diciembre - Febrero", "Marzo - Mayo", "Junio - Agosto", "Septiembre - Noviembre"]
	...
	def entregarEtiquetasTrimestres(self):
		return self.etiquetasTrimestres
	...
	def entregarSemestre(self, idSemestre):
		return self.entregarEtiquetasSemestres()[idSemestre]

	def entregarTrimestre(self, idTrimestre):
		return self.entregarEtiquetasTrimestres()[idTrimestre]

	def entregarMes(self, idMes):
		return self.entregarEtiquetasMeses()[idMes]
