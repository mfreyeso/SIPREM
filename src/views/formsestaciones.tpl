...
<div id="myTabContent" class="tab-content">
  <div class="tab-pane fade in active" id="create">
         <div class="col-md-6">
            <form role="form" style="padding:1cm" action="/crearEstacion" method="POST">
         ...
         <div class="col-md-6">
            <div class="form-group" style="padding:2.5cm" align="center">
                <button type="button" class="btn btn-primary btn-lg" id="btncrearestacion">Crear</button>
            </div>          
         </div>
  ...
  <div class="tab-pane fade" id="dese">
    <div class="col-md-6">
      <form role="form">
        <div class="form-group" style="padding:1.5cm">
          <label for="estacion">Estación</label>
    ...
    <div class="col-md-6">
      <div class="form-group" style="padding:1.7cm" align="center">
        <button type="button" class="btn btn-primary btn-lg" id="btndesestacion">Desactivar</button>        
      </div>      
    </div>
  </div>
  ...
  <div class="tab-pane fade" id="acte">
    ...
    <div class="col-md-6">
      <div id="activestacion" style="padding-top:1cm">
        
      </div>
      <div style="padding-top:0.5cm" align="center">
